...
class Model(nn.Module):
    ...
    def __init__(self, input_size=128, lstm_size=256, lstm_layers=1, output_size=256):
        # Call parent
        super().__init__()
        # Define parameters
        ...
        self.lstm = nn.LSTM(input_size, lstm_size, num_layers=lstm_layers, batch_first=False)
        self.output = nn.Linear(lstm_size, output_size)
        self.classifier = nn.Linear(output_size,4)
        
    def forward(self, x, return_eeg_repr=False):
